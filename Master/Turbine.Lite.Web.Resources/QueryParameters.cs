...
namespace Turbine.Lite.Web.Resources
{
    public class QueryParameters
    {
        ...
        internal static string GetData(string defaultValue, string dataname)
        {
            string val = defaultValue;
            string param = WebOperationContext.Current.IncomingRequest.UriTemplateMatch.QueryParameters[dataname];
            if (string.IsNullOrEmpty(param))
                return val;
