...
namespace Turbine.Consumer.SimSinter
{
    ...
    public class SinterConsumerMonitor : IConsumerMonitor
    {
        ...
        public virtual void MonitorTerminate()
        {
            ...
            {
                Debug.WriteLine("Stopping Simulation Failed", "SinterConsumerMonitor.MonitorTerminate");
                Debug.WriteLine(e.Message, "MonitorTermSinterConsumerMonitor.MonitorTerminateinate");
                Debug.WriteLine(e.StackTrace, "MonitorTSinterConsumerMonitor.MonitorTerminateerminate");
            ...
            if (!stopped)
            {
                ...
                catch (Exception e)
                {
                    ...
                    Debug.WriteLine(e.Message, "SinterConsumerMonitor.MonitorTerminate");
                    Debug.WriteLine(e.StackTrace, "MonSinterConsumerMonitor.MonitorTerminateitorTerminate");
        ...
        public int Monitor(bool cancelKeyPressed)
        {
            ...
            if (cancelKeyPressed == true)
            {
                ...
                try
                {
                    Debug.WriteLine("MonitorTerminated: Cancel Key Pressed", "SinterConsumerMonitor.Monitor");
                    MonitorTerminate();
                }
                catch (Exception ex)
                {
                    Debug.WriteLine("MonitorTerminate Failed", "SinterConsumerMonitor.Monitor");
                    Debug.WriteLine("Message: " + ex.Message, "SinterConsumerMonitor.Monitor");
                    Debug.WriteLine("StackTrace: " + ex.StackTrace, "SinterConsumerMonitor.Monitor");
            ...
            {
                Debug.WriteLine("Aspen 8.4 Checking Terminate starts", "SinterConsumerMonitor.Monitor");
        ...
        public int CheckTerminate()
        {
            if (isTerminated)
            {
                Debug.WriteLine("Job is already Terminated", "SinterConsumerMonitor.CheckTerminate");
                return -1;
            }
